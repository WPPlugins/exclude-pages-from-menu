...
Plugin URI:        http://freewptp.com/plugins/exclude-pages-from-menu/
Description:       The plugin provides option to remove page from menu if the menu is created using wp_page_menu function
Version:           1.0
Author:            Vinod Dalvi
